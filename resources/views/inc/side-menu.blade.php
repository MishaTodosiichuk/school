<div class="side-menu">
    <ul class="menu">
        <li class="menu-list"><a href="{{route('status.index')}}">Прозорість та інформаційна відкритість</a>
            <ul class="menu-drop">
                <li>
    ...
    <div class="cabinet">
        @if(auth()->user())
            <a href="{{route('profile.edit')}}" class="btn btn-cabinet"><b>Профіль</b></a>
        @else
            <a href="{{route('login')}}" class="btn btn-cabinet"><b>Кабінет для персоналу </b><i class="fa-solid fa-lock"></i></a>
        @endif
    </div>
    <hr>
    <div class="banner_block">
        <p><a rel="nofollow" href="https://mon.gov.ua/ua" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431247/0e595c2e22459f86d27939e4f226d0ea.png" style="width: 250px; height: 76px;"></a></p>
        <p><a rel="nofollow" href="https://osvita.cv.ua/" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431247/2dc405f1e5325a9f513737e192223452.png" style="width: 250px; height: 62px;"></a></p>
        <p><a rel="nofollow" href="https://lib.imzo.gov.ua/yelektronn-vers-pdruchnikv/" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431247/be81158f7592fc4b9d030c4c54bee53a.png" style="width: 250px; height: 78px;"></a></p>
        <p><a rel="nofollow" href="https://nz.ua/" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431247/d7e515be2b27c09dead855ab6cadd1b3.png" style="width: 250px; height: 162px;"></a></p>
        <p><a rel="nofollow" href="http://doncv.gov.ua/" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431075/ce2547d113d1b5dc79af22d52918e93d.png" style="width: 250px; height: 136px;"></a></p>
        <p><a rel="nofollow" href="https://lms.e-school.net.ua/" target="_blank"><img alt="" src="https://rada.info/upload/users_files/21431075/ec36608cc0c85db80644fb78a944195a.png" style="width: 250px; height: 45px;"></a></p>
    </div>
</div>
